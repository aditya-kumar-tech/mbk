...
window.Silverdata = function(q){
  if(!q) return;
  if(!has('#silvr_pricet') && !has('#silvr_graf') && !has('#silvr_gramtbl') && !has('#data_table1')) return; 
...
window.golddata = function(q){
  if(!q) return;
  if(!has('#g22kt') && !has('#gldgraf') && !has('#gramtbl22') && !has('#gramtbl24') && !has('#data_table1') && !has('#data_table2')) return; 
