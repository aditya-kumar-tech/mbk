(function(){
    console.log("🚀 Universal Loader v10.1 - Silver & Gold Safe");
    ...
    function parseGViz(txt){
        try{
            ...
            return rows.slice(0,15); // only last 15 days
    ...
    // ====================== FETCH CONFIG ======================
    fetch('https://aditya-kumar-tech.github.io/mbk/data/gs/silver-groups.json').then(r=>r.json()).then(j=>{silverCfg=j; console.log('✔ Silver config loaded');});
    fetch('https://aditya-kumar-tech.github.io/mbk/data/gs/gold-groups.json').then(r=>r.json()).then(j=>{goldCfg=j; console.log('✔ Gold config loaded');});
