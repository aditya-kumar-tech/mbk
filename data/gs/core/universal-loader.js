(function(){
    console.log("🚀 Universal Loader v9.0 - Gold & Silver Duplicate-Free with History & Graphs");
    ...
    function parseGViz(txt){
        try{
            ...
            // Sort by date descending if first column is date
            rows.sort((a,b)=>{
    ...
    function renderGold(rows){
        ...
        if(hist22){
            ...
            rows.forEach(r=>{
                html+=`<tr style="border-bottom:1px solid #eee;"><td style="padding:6px;">${r.c[0]?.f||''}</td><td style="text-align:right;padding:6px;">₹${r.c[1]?.v||0}</td></tr>`;
            });
            html+='</table>';
        ...
        if(hist24){
            ...
            rows.forEach(r=>{
                html+=`<tr style="border-bottom:1px solid #eee;"><td style="padding:6px;">${r.c[0]?.f||''}</td><td style="text-align:right;padding:6px;">₹${r.c[3]?.v||0}</td></tr>`;
            });
            html+='</table>';
